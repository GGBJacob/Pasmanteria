...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'db', 'port' => '3306', 'dbname' => 'prestashop', 'user' => 'root', 'password' => 'root', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('86ce8Wf6f1KkjgFLZ2Kf4C2qnvvTo3HNX1tyIqqU9GPN8BAY8zaOFNVZhXzBU8uC');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                46 => ($this->targetDirs[3].'/modules/ps_mbo/translations'),
                47 => ($this->targetDirs[3].'/modules/ps_metrics/translations'),
                48 => ($this->targetDirs[3].'/modules/ps_facebook/translations'),
                49 => ($this->targetDirs[3].'/modules/psxmarketingwithgoogle/translations'),
                50 => ($this->targetDirs[3].'/modules/blockreassurance/translations'),
                51 => ($this->targetDirs[3].'/modules/ps_accounts/translations'),
                52 => ($this->targetDirs[3].'/modules/dhlexpresscommerce/translations'),
                53 => ($this->targetDirs[3].'/modules/paypal/translations'),
                54 => ($this->targetDirs[3].'/modules/ps_cashondelivery/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.secret' => '86ce8Wf6f1KkjgFLZ2Kf4C2qnvvTo3HNX1tyIqqU9GPN8BAY8zaOFNVZhXzBU8uC',
            ...
            'prestashop.commands_and_queries' => [
                ...
                337 => 'PrestaShop\\Module\\PsAccounts\\Domain\\Shop\\Command\\LinkShopCommand',
                338 => 'PrestaShop\\Module\\PsAccounts\\Domain\\Shop\\Command\\MigrateAndLinkV4ShopCommand',
                339 => 'PrestaShop\\Module\\PsAccounts\\Domain\\Shop\\Command\\DeleteUserShopCommand',
                340 => 'PrestaShop\\Module\\PsAccounts\\Domain\\Shop\\Command\\UnlinkShopCommand',
                341 => 'PrestaShop\\Module\\PsAccounts\\Domain\\Shop\\Command\\UpdateShopCommand',
            ],
